  ...
  return (
    <div className="container">
      ...
      <div className="card">
        ...
        <div className="flex">
          <button className="btn btn-primary" onClick={openSession} disabled={session.status === 'OPEN'}>
            Mở điểm danh
          </button>
          <button className="btn btn-secondary" onClick={closeSession} disabled={session.status === 'CLOSED'}>
            Đóng điểm danh
          </button>
                ...
                <tr key={a.id}>
                  ...
                  <td>
                    {a.status === 'ON_TIME' ? (
                      ...
                      <StatusChip variant="danger" label="Vắng" />
                    )}
                  </td>
                  <td>
                    {a.photoUrl ? (
